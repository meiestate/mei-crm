// src/components/analytics/charts/revenue/RevenueByAgentChart.tsx
...
type RevenueByAgentChartProps = {
  title?: string;
  subtitle?: string;
  data?: RevenueByAgentDatum[];
  height?: number;
  loading?: boolean;
  emptyMessage?: string;
  currency?: string;
...
type ChartRow = RevenueByAgentDatum & {
  targetRevenue: number;
  collectionRate: number;
...
const defaultData: RevenueByAgentDatum[] = [
  { agent: "Arjun", revenue: 24800000, deals: 14, targetRevenue: 22000000, collectionRate: 94 },
  { agent: "Priya", revenue: 21900000, deals: 12, targetRevenue: 21000000, collectionRate: 91 },
  { agent: "Kavin", revenue: 19400000, deals: 11, targetRevenue: 18500000, collectionRate: 88 },
  { agent: "Meera", revenue: 17600000, deals: 10, targetRevenue: 17000000, collectionRate: 93 },
  { agent: "Sanjay", revenue: 15800000, deals: 9, targetRevenue: 16500000, collectionRate: 84 },
  { agent: "Nila", revenue: 14200000, deals: 8, targetRevenue: 15000000, collectionRate: 86 },
];
...
function buildChartData(data: RevenueByAgentDatum[]): ChartRow[] {
...
export default function RevenueByAgentChart({
  title = "Revenue by Agent",
  subtitle = "Compare agent-wise revenue contribution, target achievement, and collection efficiency",
  data = defaultData,
  height = DEFAULT_HEIGHT,
  loading = false,
  emptyMessage = "No agent revenue data available right now.",
  currency = DEFAULT_CURRENCY,
  showSummary = true,
}: RevenueByAgentChartProps) {
    ...
    return (
      <section style={{ ...containerStyle, height }}>
        ...
        <div style={emptyWrapStyle}>
          <p style={emptyTitleStyle}>No agent revenue data</p>
        ...
        {showSummary ? (
          ...
          >
            ...
            {bestAchiever ? (
              ...
              >
                Best vs Target: {bestAchiever.agent}
              </div>
            ) : null}
          </div>
        ) : null}
